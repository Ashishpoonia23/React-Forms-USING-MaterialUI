...
function NNForm() {
    ...
    const [rows, setRows] = useState([
        { id: 1, Name: 'Ram', Rollno: 12, CollegeName: 'University Of Mumbai', Degree: 'BBA', FatherName: 'Akash', MotherName: 'Aashvi', marks: '465' },
        { id: 2, Name: 'shyam', Rollno: 20, CollegeName: 'IIT Bombay', Degree: 'BCA', FatherName: 'Akhil', MotherName: 'Lakshmi', marks: '75' },
        { id: 3, Name: 'Aaditya', Rollno: 22, CollegeName: 'NMIMS University', Degree: 'MBA', FatherName: 'Akshay', MotherName: 'Meera', marks: '86578' },
        { id: 4, Name: 'Aarav', Rollno: 25, CollegeName: 'Grant Medical College', Degree: 'MBBS', FatherName: 'Anand', MotherName: 'Saanvi', marks: '786' },
        { id: 5, Name: 'Ajay', Rollno: 45, CollegeName: 'Tata Institute of Social Sciences', Degree: 'BSC', FatherName: 'Anil.', MotherName: 'Sarika', marks: '78678' },
    ]);
        ...
        for (var i = 0; i < table1.rows.length; i++) {
            if (i === index) {
                ...
                let tabbllee = {
                    ...
                    MotherName: table1.rows[i + 1].cells[7].innerHTML,
                }
    ...
    return (
        ...
        <form onSubmit={handleSubmit2}>
            <Container>
                ...
                <br></br>
                <TableContainer component={Paper} numSelected={selected.length}>
                    <Table sx={{ minWidth: 650 }} aria-label="simple table" id="tabl" numSelected={selected.length}>
                        ...
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell align="right"><ButtonGroup><Button onClick={handleAdd}>
                            ...
                            {rows.map((row, i) => (<>
                                ...
                                >
                                    ...
                                    <TableCell align="right"><ButtonGroup variant="contained" size="small">
                                        <Button onClick={(e) => { dataeditttt(e, i) }}
                                        ><EditIcon /></Button>
                                        <Button onClick={() => handleRemoveClick(i)}><DeleteIcon /></Button>
                            ...
                            <Table sx={{ minWidth: 650 }} aria-label="simple table" id="tabl1">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell >MothertName</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {tabl2data.map((row, i) => (
                                        ...
                                        >
                                            ...
                                            <TableCell ><TextField name="Name" id="mod1" size="small" label="Name" value={row.Name} onChange={(e) => handleInputChange(e, i)} variant="outlined" /></TableCell>
                                            <TableCell ><TextField name="Rollno" id="mod2" size="small" label="Roll No" value={row.Rollno} onChange={(e) => handleInputChange(e, i)} variant="outlined" /></TableCell>
                                            <TableCell ><TextField name="CollegeName" id="mod3" size="small" label="College Name" value={row.CollegeName} onChange={(e) => handleInputChange(e, i)} variant="outlined" /></TableCell>
                                            <TableCell ><TextField name="Degree" id="mod4" size="small" label="Degree" value={row.Degree} onChange={(e) => handleInputChange(e, i)} variant="outlined" /></TableCell>
                                            <TableCell ><TextField name="FatherName" id="mod5" size="small" label="Father Name" value={row.FatherName} onChange={(e) => handleInputChange(e, i)} variant="outlined" /></TableCell>
                                            <TableCell ><TextField name="MotherName" id="mod6" size="small" label="Mothert Name" value={row.MotherName} onChange={(e) => handleInputChange(e, i)} variant="outlined" /></TableCell>
                                            <TableCell ><Button variant="contained" onClick={handleClose}>ok</Button></TableCell>
